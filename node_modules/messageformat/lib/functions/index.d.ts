 ...
 */
export declare let DefaultFunctions: {
    /**
 ...
 * @beta
 */
export declare let DraftFunctions: {
    /**
     ...
     * or an object wrapping such a value, with a `valueOf()` accessor and an optional `options` object.
     */
    date: (ctx: import("../resolve/function-context.ts").MessageFunctionContext, options: Record<string, unknown>, operand?: unknown) => import("./datetime.ts").MessageDateTime;
    /**
     * Supports formatting as defined in LDML 47 for the
     ...
     * or an object wrapping such a value, with a `valueOf()` accessor and an optional `options` object.
     */
    datetime: (ctx: import("../resolve/function-context.ts").MessageFunctionContext, options: Record<string, unknown>, operand?: unknown) => import("./datetime.ts").MessageDateTime;
    /**
     ...
     * or an object wrapping such a value, with a `valueOf()` accessor and an optional `options` object.
     */
    time: (ctx: import("../resolve/function-context.ts").MessageFunctionContext, options: Record<string, unknown>, operand?: unknown) => import("./datetime.ts").MessageDateTime;
    /**
     * Supports formatting as defined in LDML 47 for the
